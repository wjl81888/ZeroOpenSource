...
namespace GeneralExtensions.ArticleFormatExtension
{
    public static class FormattingFunctions
    {
        /// <summary>
        /// Changes double line-breaks in the text into HTML paragraphs (<p>...</p>).
        /// https://stackoverflow.com/questions/2015563/replace-newlines-with-p-paragraph-and-with-br-tags
        /// </summary>
        /// <param name="pee">The text to be formatted.</param>
        /// <param name="br">Preserve line breaks. When set to true, any line breaks remaining after paragraph conversion are converted to HTML <br />. Line breaks within script and style sections are not affected.</param>
        /// <returns>Text which has been converted into correct paragraph tags.</returns>
        public static string WpAutoP2(string pee, bool br = true)
        {
            string result = "<p>" + pee.Replace(Environment.NewLine + Environment.NewLine, "</p><p>");

            if (br)
            {
                result = result.Replace(Environment.NewLine, "<br />").Replace("\n", "<br />");
            }
        ...
        /// Changes double line-breaks in the text into HTML paragraphs (<p>...</p>).
        /// https://github.com/braksator/WpAutoP.cs
        /// </summary>
        /// <param name="pee">The text to be formatted.</param>
        /// <param name="br">Preserve line breaks. When set to true, any line breaks remaining after paragraph conversion are converted to HTML <br />. Line breaks within script and style sections are not affected.</param>
        /// <returns>Text which has been converted into correct paragraph tags.</returns>
        public static string WpAutoP(string pee, bool br = true)
        {
            ...
            if (pee.Contains("<pre"))
            {
                var pee_parts = pee.Split(new string[] { "</pre>" }, StringSplitOptions.None);
